...
export const classes: ClassData[] = [
  ...
  },
  {
    ...
    chapters: [
      ...
      make("Periodic Classification of Elements"),
    ],
  },
  {
    classId: "11",
    ...
    chapters: [
      ...
      make("Classification of Elements and Periodicity"),
      make("Chemical Bonding and Molecular Structure"),
      make("Thermodynamics"),
      make("Equilibrium"),
      make("Redox Reactions"),
      make("Organic Chemistry – Basics"),
    ],
  },
  {
    classId: "12",
    ...
    chapters: [
      ...
      make("Surface Chemistry"),
      make("General Principles of Metallurgy"),
      make("p-Block Elements"),
